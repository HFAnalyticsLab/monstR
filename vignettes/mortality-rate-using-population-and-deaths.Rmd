...
knitr::include_graphics(here('vignettes','pop_table.PNG'),dpi=350)
```
...
```{r,echo=FALSE,fig.width = 5}
knitr::include_graphics(here('vignettes','pop_deaths.PNG'),dpi=350)
```
...
```{r,echo=FALSE,fig.width = 5}
knitr::include_graphics(here('vignettes','pop_deaths_aggregate.PNG'),dpi=350)
```
...
```{r,echo=FALSE,fig.width = 5}
knitr::include_graphics(here('vignettes','merged_table.PNG'),dpi=350)
```
...
```{r,echo=FALSE,fig.width = 5}
knitr::include_graphics(here('vignettes','mortality_by_region.png'),dpi=700)
```