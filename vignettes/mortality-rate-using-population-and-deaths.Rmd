...
```{r,echo=FALSE}
knitr::include_graphics(here('vignettes','mortality rate vignette images','pop_table.png'),dpi=250)
```
...
```{r,echo=FALSE}
knitr::include_graphics(here('vignettes','mortality rate vignette images','pop_deaths.png'),dpi=250)
```
...
```{r,echo=FALSE}
knitr::include_graphics(here('vignettes','mortality rate vignette images','pop_deaths_aggregate.png'),dpi=250)
```
...
```{r,echo=FALSE}
knitr::include_graphics(here('vignettes','mortality rate vignette images','merged_table.png'),dpi=250)
```
...
```{r,echo=FALSE}
knitr::include_graphics(here('vignettes','mortality rate vignette images','mortality_by_region.png'),dpi=700)
```