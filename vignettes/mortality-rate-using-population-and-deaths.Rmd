...
```{r,echo=FALSE}
knitr::include_graphics(here('vignettes','pop_table.PNG'),dpi=250)
```
...
```{r,echo=FALSE}
knitr::include_graphics(here('vignettes','pop_deaths.PNG'),dpi=250)
```
...
```{r,echo=FALSE}
knitr::include_graphics(here('vignettes','pop_deaths_aggregate.PNG'),dpi=250)
```
...
```{r,echo=FALSE}
knitr::include_graphics(here('vignettes','merged_table.PNG'),dpi=250)
```
